...
Spanish (or Castilian; Uruguay) spelling dictionary in UTF-8.
...
```sh
npm install dictionary-es-uy
```

## Use

```js
var esUy = require("dictionary-es-uy");

esUy(function (err, result) {
...
var base = require.resolve("dictionary-es-uy");
...
Dictionary and affix file: [(GPL-3.0 OR LGPL-3.0 OR MPL-1.1)](https://github.com/wooorm/dictionaries/blob/main/dictionaries/es-UY/license).
