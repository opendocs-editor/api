...
Spanish (or Castilian; United States) spelling dictionary in UTF-8.
...
```sh
npm install dictionary-es-us
```

## Use

```js
var esUs = require("dictionary-es-us");

esUs(function (err, result) {
...
var base = require.resolve("dictionary-es-us");
...
Dictionary and affix file: [(GPL-3.0 OR LGPL-3.0 OR MPL-1.1)](https://github.com/wooorm/dictionaries/blob/main/dictionaries/es-US/license).
