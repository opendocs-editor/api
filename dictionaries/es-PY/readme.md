...
Spanish (or Castilian; Paraguay) spelling dictionary in UTF-8.
...
```sh
npm install dictionary-es-py
```

## Use

```js
var esPy = require("dictionary-es-py");

esPy(function (err, result) {
...
var base = require.resolve("dictionary-es-py");
...
Dictionary and affix file: [(GPL-3.0 OR LGPL-3.0 OR MPL-1.1)](https://github.com/wooorm/dictionaries/blob/main/dictionaries/es-PY/license).
