...
Spanish (or Castilian; Panama) spelling dictionary in UTF-8.
...
```sh
npm install dictionary-es-pa
```

## Use

```js
var esPa = require("dictionary-es-pa");

esPa(function (err, result) {
...
var base = require.resolve("dictionary-es-pa");
...
Dictionary and affix file: [(GPL-3.0 OR LGPL-3.0 OR MPL-1.1)](https://github.com/wooorm/dictionaries/blob/main/dictionaries/es-PA/license).
