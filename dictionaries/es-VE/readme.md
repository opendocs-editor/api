...
```sh
npm install dictionary-es-ve
```

## Use

```js
var esVe = require("dictionary-es-ve");

esVe(function (err, result) {
...
var base = require.resolve("dictionary-es-ve");
...
Dictionary and affix file: [(GPL-3.0 OR LGPL-3.0 OR MPL-1.1)](https://github.com/wooorm/dictionaries/blob/main/dictionaries/es-VE/license).
