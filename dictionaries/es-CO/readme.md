...
Spanish (or Castilian; Colombia) spelling dictionary in UTF-8.
...
```sh
npm install dictionary-es-co
```

## Use

```js
var esCo = require("dictionary-es-co");

esCo(function (err, result) {
...
var base = require.resolve("dictionary-es-co");
...
Dictionary and affix file: [(GPL-3.0 OR LGPL-3.0 OR MPL-1.1)](https://github.com/wooorm/dictionaries/blob/main/dictionaries/es-CO/license).
