...
Estonian spelling dictionary in UTF-8.
...
```sh
npm install dictionary-et
```

## Use

```js
var et = require("dictionary-et");

et(function (err, result) {
...
var base = require.resolve("dictionary-et");
...
Dictionary and affix file: LGPL-2.1.
...
[source]: http://www.meso.ee/~jjpp/speller
