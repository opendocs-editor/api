...
Catalan spelling dictionary in UTF-8.
...
```sh
npm install dictionary-ca
```

## Use

```js
var ca = require("dictionary-ca");

ca(function (err, result) {
...
var base = require.resolve("dictionary-ca");
...
Dictionary and affix file: [(GPL-2.0 OR LGPL-2.1)](https://github.com/wooorm/dictionaries/blob/main/dictionaries/ca/license).
