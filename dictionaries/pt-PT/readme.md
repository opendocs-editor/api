...
Portuguese (Portugal) spelling dictionary in UTF-8.
...
```sh
npm install dictionary-pt-pt
```

## Use

```js
var ptPt = require("dictionary-pt-pt");

ptPt(function (err, result) {
...
var base = require.resolve("dictionary-pt-pt");
...
Dictionary and affix file: [(GPL-2.0 OR LGPL-2.1 OR MPL-1.1)](https://github.com/wooorm/dictionaries/blob/main/dictionaries/pt-PT/license).
