...
Nepali spelling dictionary in UTF-8.
...
```sh
npm install dictionary-ne
```

## Use

```js
var ne = require("dictionary-ne");

ne(function (err, result) {
...
var base = require.resolve("dictionary-ne");
...
Dictionary and affix file: [LGPL-2.1](https://github.com/wooorm/dictionaries/blob/main/dictionaries/ne/license).
