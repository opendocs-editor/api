...
Spanish (or Castilian; Argentina) spelling dictionary in UTF-8.
...
```sh
npm install dictionary-es-ar
```

## Use

```js
var esAr = require("dictionary-es-ar");

esAr(function (err, result) {
...
var base = require.resolve("dictionary-es-ar");
...
Dictionary and affix file: [(GPL-3.0 OR LGPL-3.0 OR MPL-1.1)](https://github.com/wooorm/dictionaries/blob/main/dictionaries/es-AR/license).
