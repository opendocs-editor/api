...
Spanish (or Castilian; Guatemala) spelling dictionary in UTF-8.
...
```sh
npm install dictionary-es-gt
```

## Use

```js
var esGt = require("dictionary-es-gt");

esGt(function (err, result) {
...
var base = require.resolve("dictionary-es-gt");
...
Dictionary and affix file: [(GPL-3.0 OR LGPL-3.0 OR MPL-1.1)](https://github.com/wooorm/dictionaries/blob/main/dictionaries/es-GT/license).
