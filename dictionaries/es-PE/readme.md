...
Spanish (or Castilian; Peru) spelling dictionary in UTF-8.
...
```sh
npm install dictionary-es-pe
```

## Use

```js
var esPe = require("dictionary-es-pe");

esPe(function (err, result) {
...
var base = require.resolve("dictionary-es-pe");
...
Dictionary and affix file: [(GPL-3.0 OR LGPL-3.0 OR MPL-1.1)](https://github.com/wooorm/dictionaries/blob/main/dictionaries/es-PE/license).
