...
Turkish spelling dictionary in UTF-8.
...
```sh
npm install dictionary-tr
```

## Use

```js
var tr = require("dictionary-tr");

tr(function (err, result) {
...
var base = require.resolve("dictionary-tr");
...
Dictionary and affix file: [MIT](https://github.com/wooorm/dictionaries/blob/main/dictionaries/tr/license).
...
[source]: http://extensions.openoffice.org/en/project/turkish-spellcheck-dictionary
