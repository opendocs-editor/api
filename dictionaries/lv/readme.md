...
Latvian spelling dictionary in UTF-8.
...
```sh
npm install dictionary-lv
```

## Use

```js
var lv = require("dictionary-lv");

lv(function (err, result) {
...
var base = require.resolve("dictionary-lv");
...
Dictionary and affix file: [LGPL-2.1](https://github.com/wooorm/dictionaries/blob/main/dictionaries/lv/license).
...
[source]: http://dict.dv.lv/home.php?prj=lv
