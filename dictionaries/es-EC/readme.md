...
Spanish (or Castilian; Ecuador) spelling dictionary in UTF-8.
...
```sh
npm install dictionary-es-ec
```

## Use

```js
var esEc = require("dictionary-es-ec");

esEc(function (err, result) {
...
var base = require.resolve("dictionary-es-ec");
...
Dictionary and affix file: [(GPL-3.0 OR LGPL-3.0 OR MPL-1.1)](https://github.com/wooorm/dictionaries/blob/main/dictionaries/es-EC/license).
