...
English (Australia) spelling dictionary in UTF-8.
...
```js
var enAu = require("dictionary-en-au");

enAu(function (err, result) {
...
var base = require.resolve("dictionary-en-au");
...
Dictionary and affix file: [(MIT AND BSD)](https://github.com/wooorm/dictionaries/blob/main/dictionaries/en-AU/license).
