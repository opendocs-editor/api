...
```sh
npm install dictionary-es-do
```

## Use

```js
var esDo = require("dictionary-es-do");

esDo(function (err, result) {
...
var base = require.resolve("dictionary-es-do");
...
Dictionary and affix file: [(GPL-3.0 OR LGPL-3.0 OR MPL-1.1)](https://github.com/wooorm/dictionaries/blob/main/dictionaries/es-DO/license).
