...
Spanish (or Castilian; Nicaragua) spelling dictionary in UTF-8.
...
```js
var esNi = require("dictionary-es-ni");

esNi(function (err, result) {
...
var base = require.resolve("dictionary-es-ni");
...
Dictionary and affix file: [(GPL-3.0 OR LGPL-3.0 OR MPL-1.1)](https://github.com/wooorm/dictionaries/blob/main/dictionaries/es-NI/license).
