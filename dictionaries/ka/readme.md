...
Georgian spelling dictionary in UTF-8.
...
```sh
npm install dictionary-ka
```

## Use

```js
var ka = require("dictionary-ka");

ka(function (err, result) {
...
var base = require.resolve("dictionary-ka");
...
Dictionary and affix file: [MIT](https://github.com/wooorm/dictionaries/blob/main/dictionaries/ka/license).
...
[source]: https://github.com/gamag/ka_GE.spell
