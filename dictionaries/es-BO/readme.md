...
Spanish (or Castilian; Bolivia) spelling dictionary in UTF-8.
...
```sh
npm install dictionary-es-bo
```

## Use

```js
var esBo = require("dictionary-es-bo");

esBo(function (err, result) {
...
var base = require.resolve("dictionary-es-bo");
...
Dictionary and affix file: [(GPL-3.0 OR LGPL-3.0 OR MPL-1.1)](https://github.com/wooorm/dictionaries/blob/main/dictionaries/es-BO/license).
