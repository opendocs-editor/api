...
Western Armenian spelling dictionary in UTF-8.
...
```sh
npm install dictionary-hyw
```

## Use

```js
var hyw = require("dictionary-hyw");

hyw(function (err, result) {
...
var base = require.resolve("dictionary-hyw");
...
Dictionary and affix file: [(GPL-2.0 OR LGPL-2.1 OR MPL-1.1)](https://github.com/wooorm/dictionaries/blob/main/dictionaries/hyw/license).
