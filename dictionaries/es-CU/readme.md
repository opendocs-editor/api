...
Spanish (or Castilian; Cuba) spelling dictionary in UTF-8.
...
```sh
npm install dictionary-es-cu
```

## Use

```js
var esCu = require("dictionary-es-cu");

esCu(function (err, result) {
...
var base = require.resolve("dictionary-es-cu");
...
Dictionary and affix file: [(GPL-3.0 OR LGPL-3.0 OR MPL-1.1)](https://github.com/wooorm/dictionaries/blob/main/dictionaries/es-CU/license).
