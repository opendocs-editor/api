...
Spanish (or Castilian; Philippines) spelling dictionary in UTF-8.
...
```js
var esPh = require("dictionary-es-ph");

esPh(function (err, result) {
...
var base = require.resolve("dictionary-es-ph");
...
Dictionary and affix file: [(GPL-3.0 OR LGPL-3.0 OR MPL-1.1)](https://github.com/wooorm/dictionaries/blob/main/dictionaries/es-PH/license).
