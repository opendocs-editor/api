...
Galician spelling dictionary in UTF-8.
...
```sh
npm install dictionary-gl
```

## Use

```js
var gl = require("dictionary-gl");

gl(function (err, result) {
...
var base = require.resolve("dictionary-gl");
...
Dictionary and affix file: [GPL-3.0](https://github.com/wooorm/dictionaries/blob/main/dictionaries/gl/license).
...
[source]: https://github.com/meixome/hunspell-gl
