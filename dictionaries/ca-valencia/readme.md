...
Catalan (Valencian) spelling dictionary in UTF-8.
...
```js
var caValencia = require("dictionary-ca-valencia");

caValencia(function (err, result) {
...
var base = require.resolve("dictionary-ca-valencia");
