...
```sh
npm install dictionary-es-cl
```

## Use

```js
var esCl = require("dictionary-es-cl");

esCl(function (err, result) {
...
var base = require.resolve("dictionary-es-cl");
...
Dictionary and affix file: [(GPL-3.0 OR LGPL-3.0 OR MPL-1.1)](https://github.com/wooorm/dictionaries/blob/main/dictionaries/es-CL/license).
